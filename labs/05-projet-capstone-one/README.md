...
- supprimer `labs/05-projet-capstone-one/.capstone-resources.json`
- relancer avec un suffixe unique  
  `CAPSTONE_SUFFIX=\"prenom-nom-$(date +%s)\" npx ts-node src/deploy-project.ts`
